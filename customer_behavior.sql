...
-- Q6. Which 5 products have the highest percentage of purchases with discounts applied?
        ...
        count(case when discount_applied='Yes' then 1 end )/ count(*) * 100 as discount_percentage
        from customer_table
        group by item_purchased 
...
-- Q7. Segment customers into New, Returninitem_purchasedg, and Loyal based on their total number of previous purchases, and show the count of each segment.
